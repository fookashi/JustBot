...
DEMO_TEXTS = (
    ...
    ("как скачать?", ""),
    ("Ладно.", "текст"),
    ("Мыний гесли", "Демотец окрасской рутии"),
    ("How?", "Текст"),
    ("Я клитор", "Запомнили?"),
    ("Подумай о будущем", "купи сигарет на завтра"),
    ("в мои времена поп ит", "выглядел так"),
    ("квадратное уравнение", "через дискриминант"),
    ("ДИДЖЕЙ ТЕЙП", "АБУ БЭ БУБЭ БУБЭЭЭ"),
    ("Признайся", "захотел"),
    ("Кто-нибудь знает", "как избавиться от этой хуйни"),
    ("в поисках папы", ""),
    ("Ебать его хуй", "это же огузок шелбии"),
...
class DemotivatorCreator:
    ...
    async def create_demotivator(self, image: ImageToDemotivator) -> DemotivatorImage | None:
        form_data = aiohttp.FormData()

        (text1, text2) = choice(DEMO_TEXTS)  # noqa: S311
